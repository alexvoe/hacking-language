...
// font-variation-settings:'temp' 700, 'yest' 148.08, 'grvt' 331.64
       ...
       // var color = "rgb(" + r + "," + g + "," + b + ")"
        var peakVal = 200;
       // var peakColor = "rgba(241, 59,  33, 1)"

        // Sorry. There is no pretty way to write this right now :/
        ...
        updateFontStyles(fontstylescold, fontstyleshot, color, r, g, b, peakColor)
      });
    }
    animateWord();
  }
...
var updateFontStyles = function(fontstylescold,fontstyleshot) {
  if (r > 180) {
    ...
    // editableText.textContent = 'Ice Ice Baby';
